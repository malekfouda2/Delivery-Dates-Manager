...
final class Delivery_Dates_Manager {
    ...
    public function activate() {
        $defaults = array(
            ...
            'ddm_normal_pickup_cutoff_time' => '14:00',
        );
    ...
    private function force_no_autoload() {
        global $wpdb;
        $names = array( 'ddm_zone_settings', 'ddm_global_blocked_dates', 'ddm_pickup_message', 'ddm_pickup_cutoff_time', 'ddm_normal_pickup_cutoff_time' );
